            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <main class="container mt-4 main-section">
                        <h2 class="mb-3">Beasiswa Selesai</h2>
                        <div class="row">
                        <?php
                            $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM arsip where keterangan='selesai' GROUP BY id_beasiswa ORDER BY id_beasiswa");
                            while ($user = mysqli_fetch_array($ambilsemuadatastock)) {
                                $beasiswa_id = $user['id_beasiswa'];
                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM arsip WHERE id_beasiswa = $beasiswa_id");
                                $count4 = mysqli_num_rows($ambilsemuadata);
                            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Keterangan: <?php echo $user['keterangan']; ?></p>
                                            <p class="card-text">Jumlah Peserta: <?php echo $count4; ?></p> 
