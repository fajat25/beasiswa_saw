            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <main class="container mt-4 main-section">
                        <h2 class="mb-3">Beasiswa yang Berjalan</h2>
                        <div class="row">
                        <?php
                            ...
                            while ($user = mysqli_fetch_array($ambilsemuadatastock)) {
                                ...
                                $ambilsemuadata = mysqli_query($conn, "SELECT * FROM data_siswa WHERE id_beasiswa = $beasiswa_id");
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Jumlah Peserta: <?php echo $count4; ?></p> <!-- Perbaikan: Menggunakan variabel $count4 yang sudah dihitung -->
